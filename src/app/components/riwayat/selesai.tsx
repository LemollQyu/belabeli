...
const Selesai = ({ dataSelesai }: any) => {
  ...
  console.log("data selesai di component = ", dataSelesai);
  return (
    <>
      {dataSelesai?.length > 0 ? null : (
      ...
      {/* --- Card toko status : selesai belum diulas----- */}
      {dataSelesai?.map?.((itemSelesai: any, index: number) => {
        return (
          <div className="relative items-center py-3 text-sm transition-all duration-200 rounded-md cursor-pointer text-black-80 border-white-30 w-full max-w-[444px] bg-gray-100 mt-3">
            ...
            <div className="flex items-center justify-between h-[38px]">
              <div className="flex items-center space-x-2 pl-4">
                ...
                {itemSelesai.merchant.super_seller && (
              ...
              <div className="pr-4">
                <a onClick={openModal}>
                  ...
                  >
                    <path
                      d="M7.41347 10.0152L4.61419 8.48827C4.12757 9.00833 3.43507 9.33333 2.66667 9.33333C1.19391 9.33333 0 8.1394 0 6.66667C0 5.19391 1.19391 4 2.66667 4C3.43503 4 4.1275 4.32497 4.61412 4.84497L7.41347 3.31809C7.36113 3.10961 7.33333 2.89138 7.33333 2.66667C7.33333 1.19391 8.52727 0 10 0C11.4727 0 12.6667 1.19391 12.6667 2.66667C12.6667 4.13943 11.4727 5.33333 10 5.33333C9.2316 5.33333 8.53913 5.00834 8.05247 4.48831L5.25318 6.0152C5.30553 6.22367 5.33333 6.44193 5.33333 6.66667C5.33333 6.8914 5.30554 7.1096 5.25321 7.31807L8.05253 8.845C8.53913 8.325 9.2316 8 10 8C11.4727 8 12.6667 9.19393 12.6667 10.6667C12.6667 12.1394 11.4727 13.3333 10 13.3333C8.52727 13.3333 7.33333 12.1394 7.33333 10.6667C7.33333 10.4419 7.36113 10.2237 7.41347 10.0152ZM2.66667 8C3.40305 8 4 7.40307 4 6.66667C4 5.93027 3.40305 5.33333 2.66667 5.33333C1.93029 5.33333 1.33333 5.93027 1.33333 6.66667C1.33333 7.40307 1.93029 8 2.66667 8ZM10 4C10.7364 4 11.3333 3.40305 11.3333 2.66667C11.3333 1.93029 10.7364 1.33333 10 1.33333C9.2636 1.33333 8.66667 1.93029 8.66667 2.66667C8.66667 3.40305 9.2636 4 10 4ZM10 12C10.7364 12 11.3333 11.4031 11.3333 10.6667C11.3333 9.93027 10.7364 9.33333 10 9.33333C9.2636 9.33333 8.66667 9.93027 8.66667 10.6667C8.66667 11.4031 9.2636 12 10 12Z"
                      fill="#5F5F5F"
                    />
                  </svg>
                </a>
            ...
            {/* --- Body toko ----- */}
            {itemSelesai?.order_items?.map?.((item: any, index: number) => {
              return (
                <>
                  <div
                    key={index}
                  ...
                  >
                    ...
                    <div className="w-4/6">
                      <Link
                        href={`/transaksi/detail/${itemSelesai?.uuid}?q=selesai`}
                      >
                        ...
                        <div className="flex flex-wrap items-center mb-1 mt-4">
                          ...
                          <p className="text-xs">
                            {" "}
                            {itemSelesai.merchant?.city},{" "}
                            {itemSelesai.merchant?.province}
                          </p>
                        </div>
                        ...
                        <div className="pt-2 px-4 font-nunito text-[12px] font-bold flex items-center gap-2">
                          <span>Total</span>
                          <span>Rp{itemSelesai?.total_amount}</span>
                        </div>
                      </Link>
                    </div>
                  </div>
                  <div className="w-full justify-center mt-4 px-4">
                    <Link
                      href={`/${item.product.slug}/beri-ulasan?orderId=${item?.orders_id}`}
                      className="w-full"
                    >
                      <button className="bg-[#FDFDFD] text-[#51D7B1] border-[#51D7B1] border-2 font-semibold py-2 px-2 rounded-l-lg w-1/2 text-[12px]">
                        Kirim Ulasan
                      </button>
                    </Link>
                    ...
                    <button
                      ...
                      className="bg-[#51D7B1] border-2 border-[#51D7B1] text-white font-semibold py-2 px-2 rounded-r-lg w-1/2 text-[12px] border-l-4 "
                    >
                      Beli Lagi
                    </button>
                  </div>
      ...
      {/* --- End card toko status : selesai belum diulas--- */}

      {/* --- Card toko status : selesai sudah diulas----- */}

      {/* --- End card toko status : selesai sudah diulas--- */}

      {isModalOpen && (
        <>
          <div className="fixed h-screen inset-0 bg-black bg-opacity-50 z-40"></div>
          <div
            id="modal"
          ...
          >
            <div
              className={`bg-white w-full max-w-lg rounded-3xl p-6 absolute inset-y-auto -translate-y-1/2`}
            >
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-lg font-semibold font-nunito">Bagikan</h2>
                <button
                  onClick={closeModal}
