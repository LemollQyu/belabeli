...
const NotificationDetailPage = () => {
  ...
  const handleUlasan = () => {
    ...
    router.push("/seller/dashboard/notifikasi/diulas/detail/ulasan-produk");
  };
      ...
      <div className="flex flex-col min-h-screen font-nunito">
        ...
        <div className="container mx-auto p-4 flex-grow">
          ...
          <div className="mt-4 text-center">
            <h1 className="font-bold text-[24px] text-black">Ulasan Pesanan</h1>
            <p className="text-sm text-black mt-4">
              Anda telah menerima ulasan baru dari pembeli untuk produk Anda.
              Silakan cek ulasannya di dashboard Anda
            </p>
          </div>
