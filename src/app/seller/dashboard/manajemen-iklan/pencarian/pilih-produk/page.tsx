...
const ProductSelection = () => {
  ...
  return (
    <LayoutUtama>
      ...
      <div className="container mx-auto px-4 font-nunito pt-24">
          ...
          {products.map((product) => (
            ...
            >
              <div className="flex justify-between items-center mb-2">
                ...
                <button
                  className="px-4 py-1 w-[80px] text-[12px] text-white font-semibold bg-[#51D7B1] rounded-md"
                  ...
                  <div className="mt-1 grid grid-cols-2 gap-x-2 gap-y-1 text-xs text-gray-600 font-nunito">
                    ...
                    <div className="flex items-center space-x-0.5">
                      <svg
                        ...
                        xmlns="http://www.w3.org/2000/svg"
                      >
                        <g clipPath="url(#clip0_10462_13980)">
                          <path
